...
git clone https://github.com/Little-W/android_kernel_xiaomi_ginkgo/tree/f739fd5bf17ee9b0a8b60abd8295a71deda0fad4   /1
cd /1
git remote set-url origin https://github.com/Little-W/android_kernel_xiaomi_ginkgo.git
